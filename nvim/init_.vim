...
let g:coc_global_extensions = ['coc-vimlsp', 'coc-translator', 'coc-snippets', 'coc-pairs', 'coc-marketplace', 'coc-git', 'coc-explorer', 'coc-omnisharp', 'coc-json', 'coc-sumneko-lua', 'coc-python', 'coc-erlang_ls']
"tab补全
