...
var require_graceful_fs = __commonJS((exports2, module2) => {
  ...
  function patch(fs4) {
    ...
    function readdir(path5, options, cb) {
      ...
      function go$readdir(path6, options2, cb2, startTime) {
        return fs$readdir(path6, options2, function(err, files) {
          if (err && (err.code === "EMFILE" || err.code === "ENFILE"))
            enqueue([go$readdir, [path6, options2, cb2], err, startTime || Date.now(), Date.now()]);
          else {
            if (files && files.sort)
              files.sort();
            if (typeof cb2 === "function")
